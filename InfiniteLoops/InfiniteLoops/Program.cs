...
namespace InfiniteLoops
{
    class Program
    {
        static void Main()
        {
            ...
            // a fixed infinite loop that will execute properly (I hope)
            bool isRunning = true;
            while (isRunning)
            {
            ...
            // a loop that iterated through the list and displays the index
            bool found = false;
            for (int i = 0; i < uniqueList.Count; i++)
            {
                if (uniqueList[i] == searchText)
                {
            ...
            // stop the loop once match has been found
            ...
            // loop that that iterates through the loop and displays the indicices in the list that contain matching text.
            ...
            {
                if (duplicateList[i] == searchDuplicateText)
                {
